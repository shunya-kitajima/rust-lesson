pub fn run() {
  ...
  let r2 = &s10;
  println!("{} {} {}", s10, r1, r2);
  println!("Stack address of r1 is: {:p}", &r1);
  println!("Stack address of r2 is: {:p}", &r2);
  println!("Heap memory address of r1 is : {:?}", r1.as_ptr());
  println!("Heap memory address of r2 is : {:?}", r2.as_ptr());
